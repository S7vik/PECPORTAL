...
const Dashboard = () => {
  ...
  return (
    ...
    <button
      className="md:hidden fixed top-4 left-4 z-50 p-2 bg-white rounded-md shadow-md focus:outline-none focus:ring-2 focus:ring-indigo-500"
    ...
    <div className="flex-1 flex flex-col">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between">
            ...
            <div className="mt-4 md:mt-0 relative w-full md:w-64">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-full bg-white border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
              />
            </div>
          </div>
        </div>
        ...
        {isAdmin && activeTab === 'manageUsers' && <AdminUserManagement />}
      </main>
    </div>
  </div>
