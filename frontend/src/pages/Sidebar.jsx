...
const Sidebar = ({
    ...
    return (
        <div
            ...
            } transform fixed md:relative md:translate-x-0 top-0 left-0 h-screen bg-gray-900 w-64 transition-transform duration-200 ease-in-out z-40`}
        >
            <div className="flex flex-col h-full">
                ...
                <div className="p-4 border-b border-gray-800">
                    <div className="flex items-center">
                        ...
                        <div className="ml-3">
                            ...
                            <p className="text-gray-400 text-sm">{isAdmin ? 'Administrator' : userData?.department?.toUpperCase() || 'Student'}</p>
                        </div>
                    </div>
                </div>
                ...
                <nav className="p-4 flex-1 overflow-y-auto">
                    ...
                    {isAdmin && (
                        <>
                            <p className="text-gray-400 text-xs uppercase tracking-wider mt-6 mb-2">
                                Administration
                            </p>
                            <ul className="space-y-1">
                                <li>
