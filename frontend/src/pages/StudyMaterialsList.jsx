        ...
        <div className="flex flex-col sm:flex-row items-center justify-between">
          ...
          <div className="relative w-full sm:w-auto">
            ...
            <input
              ...
              className="pl-9 pr-4 py-2 bg-gray-50 border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent w-full"
            />
          </div>
        </div>
      </div>
        ...
        <div className="p-4">
          ...
          <div className="border rounded-lg overflow-hidden h-[70vh]">
            {viewingFile.fileType === 'pdf' ? (
              ...
              ></iframe>
            ) : viewingFile.fileType === 'jpg' ||
              viewingFile.fileType === 'jpeg' ||
              viewingFile.fileType === 'png' ? (
              <img
                src={viewingFile.url}
            ...
            filteredMaterials.map((material) => (
              <div key={material.id} className="p-4 hover:bg-gray-50 transition-colors">
                <div className="flex flex-col md:flex-row items-start justify-between">
                  <div
                    className="flex-1 cursor-pointer mb-2 md:mb-0"
                  ...
                  >
                    ...
                    <div className="mt-2 flex items-center text-xs text-gray-500 space-x-4">
                      ...
                      {material.fileType && <span className="uppercase">{material.fileType}</span>}
                    </div>
                  </div>
