    ...
    return (
        <div className="bg-white rounded-xl shadow-sm p-6 mt-8">
            ...
            <div className="mb-6">
                ...
                />
                <label className="block text-sm font-medium text-gray-700 mb-1">
                    Questions will be completely based on selected topics and PREVIOUS YEAR PAPERS
                </label>
            </div>
                ...
                <div className="mt-8">
                    ...
                    {score && (
                        <div className="mb-6 p-4 bg-indigo-50 border border-indigo-200 rounded-lg">
                            <h5 className="font-semibold text-indigo-900 text-lg mb-2">Your Score</h5>
                                        ...
                                        <div
                                            ...
                                            className={`p-3 rounded-md cursor-pointer flex items-center ${
                                                ...
                                                showAnswers && option.correct
                                                    ...
                                                    : showAnswers && userAnswers[qIndex] === oIndex && !option.correct
                                                        ? 'bg-red-100 border-red-300 border'
                                                        : ''
                                            }`}
                                            onClick={() => !showAnswers && handleAnswerSelect(qIndex, oIndex)}
                                        >
